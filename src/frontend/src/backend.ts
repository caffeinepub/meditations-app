...
export class Backend implements backendInterface {
    ...
    async addSession(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addSession(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllSessions(): Promise<Array<[Principal, Array<Session>]>> {
        if (this.processError) {
            try {
    ...
    async getUserSessions(arg0: Principal): Promise<Array<Session>> {
        if (this.processError) {
            try {
